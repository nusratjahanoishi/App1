...
class NonVegetarianFoodScreen extends StatefulWidget {
  final  bool isFromveginarian;
  const NonVegetarianFoodScreen({super.key,required this.isFromveginarian});

  @override
  State<NonVegetarianFoodScreen> createState() => _NonVegetarianFoodScreenState();
}

class _NonVegetarianFoodScreenState extends State<NonVegetarianFoodScreen> {
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Visibility(
                          visible: foodlist[index].isvagitarian==false?true:false,
                          child: Container(
                            height: 150,
